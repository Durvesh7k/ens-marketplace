      ...
      <div className="md:w-3/6 sm:w-full  rounded-md shadow-sm shadow-slate-800 bg-slate-600/30 p-8">
        ...
        <div className="grid md:grid-cols-2 md:grid-rows-1 sm:grid-rows-2 gap-2 items-center">
          ...
          <div className="form">
            <form action="/">
              <div className="mb-3">
                <label className="mt-4 block text-white text-sm font-bold mb-2" for="username">
                  Username
                </label>
              ...
              <button className="py-1.5 px-4 mt-3 w-full  bg-cyan-400 text-black rounded-md font-medium ml-auto items-end hover:bg-cyan-600">
                Sign In
              </button>
            ...
            <button className="py-1.5 px-4  flex items-center justify-center  w-full  bg-white shadow-sm text-black rounded-md font-medium hover:bg-cyan-600">
